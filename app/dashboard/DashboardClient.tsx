...
export default function DashboardClient({ children, notifications, permissions }: { children: React.ReactNode, notifications: TopbarNotification[], permissions: string[] }) {
